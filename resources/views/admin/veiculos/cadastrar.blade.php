      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            ...
            <div class="box-body">
                <form method="POST" action="{{ route('veiculos.inserir')}}" name="myForm">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body form-group">
                <iframe name="myIframe" id="myIframe" src="{{route('rastreadores.todos')}}" frameborder="0" width="100%" height="100%"></iframe>
              </div>
